...
public class SSGDiscountTest {
    ...
    public void setUp() {
        clothes = new Hat();
        coupon = new Hmall(clothes, "원예지", 300000);
    }
    ...
    @Test
    public void test_SSG_customer_grade() {
        assertEquals("gold", coupon.customer_grade());
    }

    @Test
    public void test_SSG_discount_result_com1() {
    ...
    @Test
    public void test_SSG_discount_result_com2() { // wendnesday 가정
    ...
    @Test
    public void test_SSG_select_discount() {
        GetDayCalendar calendar = new GetDayCalendar(2022, 6, 7);
        String day = calendar.check();
        coupon.event_day(day);
        String customerGrade = coupon.customer_grade();
